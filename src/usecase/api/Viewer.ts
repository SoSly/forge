        ...
        try {
            ...
            switch (document?.type) {
                ...
                case 'markdown':
                    ...
                    contents.push('<div id="image-zoom-overlay" class="image-zoom-overlay" style="display: none;">');
                    contents.push('  <div class="image-zoom-container">');
                    contents.push('    <img id="image-zoom-image" class="image-zoom-image" alt="Zoomed image" />');
                    contents.push('  </div>');
                    contents.push('</div>');
                    contents.push('<script>');
                    contents.push('document.addEventListener("DOMContentLoaded", function() {');
                    contents.push('  const overlay = document.getElementById("image-zoom-overlay");');
                    contents.push('  const zoomImage = document.getElementById("image-zoom-image");');
                    contents.push('  function openZoom(src) {');
                    contents.push('    zoomImage.src = src;');
                    contents.push('    overlay.style.display = "flex";');
                    contents.push('    document.body.style.overflow = "hidden";');
                    contents.push('  }');
                    contents.push('  function closeZoom() {');
                    contents.push('    overlay.style.display = "none";');
                    contents.push('    document.body.style.overflow = "";');
                    contents.push('  }');
                    contents.push('  overlay.addEventListener("click", closeZoom);');
                    contents.push('  document.addEventListener("keydown", function(e) {');
                    contents.push('    if (e.key === "Escape") closeZoom();');
                    contents.push('  });');
                    contents.push('  document.querySelectorAll("img.zoomable").forEach(function(img) {');
                    contents.push('    img.addEventListener("click", function() { openZoom(img.src); });');
                    contents.push('  });');
                    contents.push('});');
                    contents.push('</script>');
