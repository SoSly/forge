...
export class sizes1593160758510 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE document ADD COLUMN "size" int NOT NULL DEFAULT 0`);
        
        await queryRunner.query(`ALTER TABLE folder ADD COLUMN "size" int NOT NULL DEFAULT 0`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE folder DROP COLUMN "size"`);
    }
}
